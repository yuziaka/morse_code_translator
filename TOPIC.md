...
обычному разработчику. И конечно расскажу о том, как создать собственный пакет. Надеюсь на выходе 
...
По умолчанию pip ищет пакеты на pypi.org, но у нас есть возможность устанавливать их с приватных 
...
Как результат для того что бы опубликовать новую версию пакета достаточно выполнить две команды.
